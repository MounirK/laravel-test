        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center">
                    <img src="{{ asset('image/giphy.gif') }}" class="img-dance" />
                    <img src="{{ asset('image/giphy.gif') }}" class="img-dance" />
                    <img src="{{ asset('image/giphy.gif') }}" class="img-dance" />
                </div>
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1>🔥<span>Mounir dagana laravel/heroku test deployment</span>🔥</h1>
                </div>
                <div class="flex justify-center">
                    <img src="{{ asset('image/giphy.gif') }}" class="img-dance" />
                    <img src="{{ asset('image/giphy.gif') }}" class="img-dance" />
                ...
                <div class="ml-4 text-center text-sm text-gray-500 sm:ml-0">
                    <h1>Laravel v{{ Illuminate\Foundation\Application::VERSION }}</h1>
                </div>
            </div>
        </div>
    </body>
